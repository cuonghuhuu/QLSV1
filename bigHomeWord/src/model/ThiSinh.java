...
public class ThiSinh {
	...
	public ThiSinh(int maThiSinh, String tenThiSinh, Tinh tinhQueQuan, Date ngaySinh, boolean gioiTinh, float diemMon1,
			float diemMon2, float diemMon3) {
		super();
		this.maThiSinh = maThiSinh;
		this.tenThiSinh = tenThiSinh;
		this.tinhQueQuan = tinhQueQuan;
	...
	public Tinh getTinhQueQuan() {
		return tinhQueQuan;
	}

	public void setTinhQueQuan(Tinh tinhQueQuan) {
		this.tinhQueQuan = tinhQueQuan;
	}
	...
	public String toString() {
		return "ThiSinh [maThiSinh=" + maThiSinh + ", tenThiSinh=" + tenThiSinh + ", tinhQueQuan=" + tinhQueQuan
	...
	@Override
	public int hashCode() {
		return Objects.hash(diemMon1, diemMon2, diemMon3, gioiTinh, maThiSinh, ngaySinh, tenThiSinh, tinhQueQuan);
	}
	...
	public boolean equals(Object obj) {
		...
		return Float.floatToIntBits(diemMon1) == Float.floatToIntBits(other.diemMon1)
				...
				&& Objects.equals(tenThiSinh, other.tenThiSinh) && Objects.equals(tinhQueQuan, other.tinhQueQuan);
	}
